These data files are from the following sources.
Please refer to these sources for license information.

socr-mlb.csv: http://wiki.stat.ucla.edu/socr/index.php/SOCR_Data_MLB_HeightsWeights
